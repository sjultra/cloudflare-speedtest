...
![](./imgs/grafana-panel-view-1.png)
![](./imgs/grafana-panel-view-2.png)

Docker setup consisting out of Grafana incl. a pre-configured dashboard, InfluxDB and a [Cloudflare Speedtest CLI test](https://speed.cloudflare.com/) runner.
...
```shell
git clone https://github.com/sjultra/cloudflare-speedtest.git
```
